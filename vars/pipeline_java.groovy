                ...
                steps {
                    script {
                        ...
                        wrap([$class: 'MaskPasswordsBuildWrapper', varPasswordPairs:[
                            ...
                            sh "${sonarHome}/bin/sonar-scanner -Dsonar.projectKey=${map.app} -Dsonar.projectName=${map.app} -Dsonar.sources=${map.sonar_sources} -Dsonar.java.binaries=${map.sonar_java.binaries}"
                        }
                    }
                }
            }
